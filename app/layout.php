...
if (!function_exists('layout_header')) {
  function layout_header(string $title = 'HSN Kleiderkammer', string $active = 'home'): void {
      ...
      <style>
        ...
        *{box-sizing:border-box}
        ...
        body{
          ...
          line-height:1.35;
          /* optional: verhindert horizontales „Zittern“ durch Scrollbar-Breite */
          overflow-x:hidden;
        }
        ...
        /* Content rechts: kein 100vw, nur neben die Sidebar schieben */
        .content{
          position:relative;
          ...
          min-height:100dvh;
          /* WICHTIG: width entfernen, sonst 100vw + Scrollbar → Verschiebung */
          width:auto;
        }
    ...
    <body>
      ...
      <aside class="sidebar">
        <?php
          // aktive Seite ins Partial reichen
          $activeTmp = $active;
          $active = $activeTmp;
